...
public class ChatAnwendungsschicht extends Thread
{
     ...
     */
    public synchronized void ListenREQ(ICI ici,SDU sdu)  throws ZustandException
    {
     ...
     * @param sdu wird nicht genutzt
     */
    public synchronized void ListenREQDO(ICI ici,SDU sdu) throws ZustandException
    {
     ...
     * @param sdu wird nicht genutzt
     */
    public synchronized void VerbindungsaufbauREQ(ICI ici,SDU sdu) throws ZustandException
    {
     ...
     * @param sdu wird nicht genutzt
     */
    public  synchronized void VerbindungsaufbauREQDO(ICI ici,SDU sdu) throws ZustandException
    {
        ...
        if(client  != null){
            ...
            Socket socket = clientVerbindung.openConnection(ici.ip, ici.port);
            ...
            System.out.println("ClientType: "+client);
     ...
     * @param sdu wird nicht genutzt
     */
    public synchronized void ServerListenerReturn(ICI ici,SDU sdu)  throws ZustandException
    {
        getSocketZustand(ici.socket).zustand.ServerListenerReturn(this,ici,sdu);
    }    
     ...
     * @param sdu wird nicht genutzt
     */
    public synchronized void ServerListenerReturnDO(ICI ici,SDU sdu) throws ZustandException
    {
        System.out.println("ChatAnwendungsschicht: ServerListenerReturn("+ici.toString()+","+"––"+")");
        if(server  != null){
            ...
            System.err.println("ServerListenerReturn: kein Server");
        }
    }
     ...
     * @param sdu wird nicht genutzt
     */
    public synchronized void VerbindungsabbauAnfrageREQ(ICI ici,SDU sdu) throws ZustandException
    {
     ...
     * @param sdu wird nicht genutzt
     */
    public synchronized void VerbindungsabbauAnfrageREQDO(ICI ici,SDU sdu) throws ZustandException
    {
     ...
     * @param sdu wird nicht genutzt
     */
    public synchronized void VerbindungsabbauAnfrageIND(ICI ici,SDU sdu) throws ZustandException
    {
     ...
     * @param sdu wird nicht genutzt
     */
    public synchronized void VerbindungsabbauAnfrageINDDO(ICI ici,SDU sdu) throws ZustandException
    {
     ...
     * @param sdu wird nicht genutzt
     */
    public synchronized void VerbindungsabbauREQ(ICI ici,SDU sdu) throws ZustandException
    {
     ...
     * @param sdu wird nicht genutzt
     */
    public synchronized void VerbindungsabbauREQDO(ICI ici,SDU sdu) throws ZustandException
    {
     ...
     * @param sdu wird nicht genutzt
     */
    public synchronized void VerbindungsabbauIND(ICI ici,SDU sdu) throws ZustandException
    {
     ...
     * @param sdu wird nicht genutzt
     */
    public synchronized void VerbindungsabbauINDDO(ICI ici,SDU sdu) throws ZustandException
    {
     ...
     */
    public synchronized void TextREQ(ICI ici,SDU sdu)  throws ZustandException
    {
     ...
     * @param sdu Text, der übertragen wird
     */
    public synchronized void TextREQDO(ICI ici,SDU sdu) throws ZustandException
    {
     ...
     */
    public synchronized void TextAnmeldenREQ(ICI ici,SDU sdu) throws ZustandException
    {
     ...
     * @param sdu Text, der übertragen werden soll
     */
    public synchronized void TextAnmeldenREQDO(ICI ici,SDU sdu) throws ZustandException
    {
     ...
     */
    public synchronized void TextIND(ICI ici,SDU sdu) throws ZustandException
    {
     ...
     * @param sdu Text, der übertragen wurde
     */
    public synchronized void TextINDDO(ICI ici,SDU sdu) throws ZustandException
    {
     ...
     * @param sdu Text, der übertragen werden soll
     */
    public synchronized void TextAnmeldenIND(ICI ici,SDU sdu) throws ZustandException
    {
     ...
     * @param sdu Text, der übertragen werden soll
     */
    public synchronized void TextAnmeldenINDDO(ICI ici,SDU sdu) throws ZustandException
    {
